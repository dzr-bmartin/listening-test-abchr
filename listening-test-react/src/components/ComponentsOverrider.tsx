...
import { AbchrTestItemExampleCard } from "./audio/Abchr/AbchrTestItemExampleCard";
...
import { AbchrAddItemButtonGroup } from "./audio/Abchr/AbchrAddItemButtonGroup";
...
export function overrideExampleItem(testUrl: TestUrl): TestItemExampleCardType {
  switch (testUrl) {
    ...
    case "abchr-test":
      return AbchrTestItemExampleCard;
    case "hearing-test":
...
export function TestDetailViewWrapper({ testUrl }: { testUrl: TestUrl }) {
  switch (testUrl) {
    ...
    case "abchr-test":
      return <TestDetailView testUrl={testUrl} ButtonGroup={AbchrAddItemButtonGroup} />
    case "hearing-test":
